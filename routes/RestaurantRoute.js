...
//Read By ID
//http://localhost:8081/resturant?id=63dea21b728b700bd0a6d916
...
//http://localhost:8081/restaurants/cusine/Italian
//http://localhost:8081/restaurants/cusine/Vietnamese
app.get('/restaurants/cusine/:type', async (req, res) => {
  const cusine = req.params.type;
  const restaurants = await restaurantModel.find({ cusine: cusine });

  //Using Virtual Field Name
  console.log(restaurants[0].ownerEmail);

  //Using Instance method
  console.log(restaurants[0].getAllRestaurantInfo());
...
//Sort Restaurants either in ASC or DESC order
...
app.get('/restaurants/search?', async (req, res) => {
  ...
  //   res.send(
  //     JSON.stringify({ status: false, message: 'Insufficient query parameter' })
  //   );
  // } else {
